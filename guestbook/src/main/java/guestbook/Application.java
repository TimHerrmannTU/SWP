...
public class Application {
	...
	CommandLineRunner init(GuestbookRepository guestbook) {
		...
		return args -> {
			...
			Stream.of( //
					new GuestbookEntry("H4xx0r", "first!!!", "pls_dont_write_me@no-spam.com"), //
					new GuestbookEntry("Arni", "Hasta la vista, baby", "Get2TheChopper@BFG.de"), //
					new GuestbookEntry("Duke Nukem", "It's time to kick ass and chew bubble gum. And I'm all out of gum.", "2RBetterThen1@BFG.com"), //
					new GuestbookEntry("Gump1337", "Mama always said life was like a box of chocolates. You never know what you're gonna get.", "Ae/f8&&d@gmail.com")) //
